...
{
    /// <summary>
    /// This class represents the token format for the CustomToken.
    /// </summary>
    public class CustomToken : SecurityToken
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomToken"/> class.
        /// This is internal contructor is only called from the <see cref="CustomTokenHandler"/> when reading a token received from the wire.
        /// </summary>
        ...
        internal CustomToken( NameValueCollection properties, string serializedToken )
            : this(properties)
        {
        ...
        /// </summary>
        /// <param name="properties">The collection represents all the key value pairs in the token.</param>
        public CustomToken( NameValueCollection properties )
        {
            if ( properties == null )
            {
        ...
        public override string Id
        {
            get 
            {
                return _properties[CustomTokenConstants.Id];
            }
        }
        ...
        public override DateTime ValidFrom
        {
            get 
            {
                string validFrom = _properties[CustomTokenConstants.ValidFrom];
        ...
        public override DateTime ValidTo
        {
            get
            {
                string expiryTime = _properties[CustomTokenConstants.ExpiresOn];
        ...
        public string Audience
        {
            get 
            {
                return _properties[CustomTokenConstants.Audience];
            }
        }
        ...
        public string Issuer
        {
            get 
            { 
                return _properties[CustomTokenConstants.Issuer]; 
            }
        }
        ...
        public string Signature
        {
            get 
            { 
                return _properties[CustomTokenConstants.Signature]; 
            }
        }
